...
export default function UpdateEventForm({ event, className = '' }) {
    const { data, setData, put, errors, processing, recentlySuccessful } =
        useForm({
            ...
            coviturage_possible: event.coviturage_possible,
            dejeuner_prevu: event.dejeuner_prevu,
            type_public: event.type_public,
    ...
    return (
        <section className={className}>
            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                ...
                <div>
                    <InputLabel htmlFor="coviturage_possible" value="Covoiturage possible" />
